...
int main(int argc, char *argv[])
{
	...
	if (!(cmdOptionExists(argv, argv + argc, "-cIp") && cmdOptionExists(argv, argv + argc, "-cUsr") && cmdOptionExists(argv, argv + argc, "-cPwd")
		  ...
		  && cmdOptionExists(argv, argv + argc, "-fIp") && cmdOptionExists(argv, argv + argc, "-fUsr") && cmdOptionExists(argv, argv + argc, "-fPwd")
#endif
			  ))
	{
	...
	{
		std::cout << "Boo no connection\n";
		PrintErr(proxyDevice.soap);
		return -1;
	}

	// TODO: Create ptz profile
	// TODO: Test pan tilt
